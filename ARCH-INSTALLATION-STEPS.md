...
79. systemctl enable snapper-timeline.timer
80. systemctl enable snapper-cleanup.timer
81. systemctl enable grub-btrfsd
...
# First Boot Setup
85. nmtui -> Activate your wifi connection
86. sudo vim /etc/pacman.conf
87. Find and uncomment [multilib] and the line below it
88. pacman -Syu
# Install yay**
89. cd /tmp
90. git clone https://aur.archlinux.org/yay.git
91. cd yay
92. makepkg -si
# Multi-gpu consistent symlink**
93. See the file in the dotfiles folder called amd-igu rules and do that for hyprland to use amdgpu as display gpu and for all and use nvidia as offload using nvidia-prime. For more clear step by step info visit https://wiki.hypr.land/Configuring/Multi-GPU/

# Hyprland Installation
94. sudo pacman -Syu
95. sudo pacman -S hyprland wayland-protocols xorg-xwayland qt5-wayland qt6-wayland \
...
96. yay -S hyprshutdown
97. sudo systemctl enable sddm
98. reboot

# Copy from my dotfiles repo
99. Can clone or copy individual necessary files or folder like waybar, rofi, hypr, etc which also 
